...
clear all
capture log close
log using "tibbles_melse_inset_zipF/tibbles_inset.log" ,replace
...
graph save p1 "tibbles_melse_inset_zipF/tibbles_melse_inset_fig1.eps", replace
...
graph display grc
graph save grc "tibbles_melse_inset_zipF/tibbles_melse_inset_fig2.eps", replace
...
graph display grc
graph save grc "tibbles_melse_inset_zipF/tibbles_melse_inset_fig3.eps", replace
...
graph save p4 "tibbles_melse_inset_zipF/tibbles_melse_inset_fig4.eps", replace
...
graph save p5 "tibbles_melse_inset_zipF/tibbles_melse_inset_fig5.eps", replace
